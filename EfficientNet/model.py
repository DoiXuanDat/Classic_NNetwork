...
from config import base_model, phi_values
...
class EfficientNet(nn.Module):
    def __init__(self, version, num_classes):
        ...
        last_channels = ceil(1200 * width_factor)
    ...
    def calculate_factors(self, version, aplha=1.2, beta=1.1):
        phi, res, drop_rate = phi_values[version]
        depth_factor = aplha ** phi
        width_factor = beta ** phi
        return depth_factor, depth_factor, drop_rate
    ...
    def create_features(self, width_factor, depth_factor, last_channels):
        ...
        for expand_ratio, channels, repeats, stride, kernel_size in base_model:
            ...
            layers_reapeats = ceil(repeats * width_factor)

            for layer in range(layers_reapeats):
